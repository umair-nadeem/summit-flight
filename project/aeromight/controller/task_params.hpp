...
static constexpr std::size_t       flight_manager_task_stack_size_in_bytes{2048u};
static constexpr std::size_t       flight_manager_task_stack_depth_in_words{flight_manager_task_stack_size_in_bytes / sizeof(uint32_t)};
static constexpr std::size_t       flight_manager_task_priority{6u};
static constexpr std::size_t       flight_manager_task_period_in_ms{20u};
...
static constexpr std::size_t       health_monitoring_task_priority{4u};
static constexpr std::size_t       health_monitoring_task_period_in_ms{40u};
