   ...
   auto operator()() const
   {
      ...
      return make_transition_table(
          ...
          *s_stopped + e_start / set_setup_state = s_init_setup,
          ...
          s_read_coefficients_wait + e_receive_done[is_coefficients_pattern_ok] / (store_coefficients, set_operational_state, publish_health) = s_measurement,
          s_read_coefficients_wait + e_receive_done[!is_coefficients_pattern_ok] / set_coefficients_pattern_error                             = s_failure,
