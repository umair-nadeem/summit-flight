...
I2c::I2c(I2cConfig& config)
    : m_i2c_config{config}
{
}

void I2c::prepare_for_communication()
{
...
bool I2c::write(const uint8_t i2c_addr, std::span<const uint8_t> tx_buffer)
{
...
bool I2c::read(const uint8_t i2c_addr, std::span<uint8_t> rx_buffer, std::optional<uint8_t> reg)
{
...
void I2c::handle_i2c_event_interrupt()
{
...
void I2c::handle_i2c_error_interrupt()
{
   stop(false);
}

bool I2c::has_error() const
{
   return (m_state == I2cState::error);
}

void I2c::register_receive_complete_callback(const ReceiveCompleteCallback callback, void* context)
{
...
void I2c::stop(const bool success)
{
   LL_I2C_GenerateStopCondition(m_i2c_config.i2c_handle);
   clear_status();
